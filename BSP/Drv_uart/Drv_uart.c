...
void USART_init(uint32_t baudrate)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD, ENABLE);   //使能GPIOC的时钟
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, ENABLE);   //使能USART3的时钟

															 //串口3对应引脚复用映射
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource8, GPIO_AF_USART3); //GPIOC10复用为USART3_tx
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource9, GPIO_AF_USART3); //GPIOC11复用为USART3_rx
